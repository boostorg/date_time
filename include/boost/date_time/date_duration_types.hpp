...
namespace date_time {
  ...
  class BOOST_SYMBOL_VISIBLE months_duration
  {
    ...
    private:
      ...
      template<class base_config>
      inline BOOST_CXX14_CONSTEXPR typename months_duration<base_config>::date_type operator+(typename months_duration<base_config>::date_type const & d,typename months_duration<base_config>::months_type const & m)
      {
        return d + m.get_offset(d);
      }
      template<class base_config>
      inline BOOST_CXX14_CONSTEXPR typename months_duration<base_config>::date_type operator+=(typename months_duration<base_config>::date_type& d,typename months_duration<base_config>::months_type const & m)
      {
        return d += m.get_offset(d);
      }
      template<class base_config>
  ...
  class BOOST_SYMBOL_VISIBLE years_duration
  {
    ...
    private:
      ...
      template<class base_config>
      inline BOOST_CXX14_CONSTEXPR typename years_duration<base_config>::date_type operator+(const typename years_duration<base_config>::date_type& d, const typename years_duration<base_config>::years_type& y)
      {
        return d + y.get_offset(d);
      }
      template<class base_config>
      inline BOOST_CXX14_CONSTEXPR typename years_duration<base_config>::date_type operator+=(typename years_duration<base_config>::date_type& d, const typename years_duration<base_config>::years_type& y)
      {
        return d += y.get_offset(d);
      }
      template<class base_config>
