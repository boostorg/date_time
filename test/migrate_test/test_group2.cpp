...
//test1 Test for getting the day of the week property of a ptime object
...
//test2 Test for adding a day to a ptime object and checking that the resulting date is correct
...
//test3 Test for adding and subtracting days from a ptime object and checking that the resulting dates are correct
...
//test14 Test for setting the day of the week property of a ptime object to a specific day and checking that the resulting date is correct
...
//test15 Test for comparing the day of the week property of two ptime objects and checking that the comparisons are correct
...
//test16 Test for parsing and getting the year
BOOST_AUTO_TEST_CASE(testParseYearsGetYear) {
    ptime test = from_time_t(TEST_TIME3 / 1000) + microseconds(TEST_TIME3 % 1000);

    BOOST_CHECK_EQUAL(2002, test.date().year());
}

//test17 Test for getting the year property of a date object and checking that it is correct
...
//test18 Test for setting and copying the year property of a date object and checking that the resulting date is correct
...
//test19 Test for setting and copying the year property of a date object using a text string and checking that the resulting date is correct
BOOST_AUTO_TEST_CASE(testPropertySetCopyTextYear) {
    date test(1972, 6, 9);
    date copy(2004, test.month(), test.day());

    check(test, 1972, 6, 9);
    check(copy, 2004, 6, 9);
}

//test20 Test for setting the year, month, and day of a date object to specific integer values and checking that the resulting date is correct.
